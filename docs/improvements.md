...
- **Documentar rutas y flujos principales**
  - Evidencia: No se detectaron rutas explicitas con heuristicas actuales.
...
- **Refactorizar archivo de alta complejidad**
  - Evidencia: agent/nodes/discovery.py tiene 391 lineas.
